...
class CheckoutController extends Controller
{
  /**
   * __construct
   * * set middleware dan set midtrans configuration
   * @return void
   */
  ...
  public function store(Request $request)
  {
    DB::transaction(function () use ($request) {
      ...
      foreach (Cart::where('customer_id', auth()->guard('api_customer')->user()->id) as $cart) {
      ...
      //* Buat transaksi ke midtrans kemudian simpan snap token nya
      $payload = [
        'transaction_details' => [
